        ...
        <nav class="navbar navbar-light">
            <div class="container-fluid">
              ...
              <form class="d-flex card2" >
                <button id="boton" type="button" class="btn btn-secondary"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-brightness-high" viewBox="0 0 16 16">
